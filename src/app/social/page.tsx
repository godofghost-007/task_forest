...
import { mockUsers, mockMessages, User, Message } from '@/lib/mock-data';
...
export default function SocialPage() {
  ...
  const conversationUsers = useMemo(() => {
    ...
    return mockUsers.filter(u => 
        u.lastMessage && 
        (u.name.toLowerCase().includes(lowercasedQuery) || u.username.toLowerCase().includes(lowercasedQuery) || u.mobile?.includes(lowercasedQuery))
    );
  }, [searchQuery]);
